namespace System.Collections.Generic
{
    ...
    public static class LinkedListExtensions
    {
        ...
        /// <param name="node">
        ///     The node after which to search for the value in the linked list, or <c>null</c> to search from the
        ///     beginning.
        /// </param>
        ...
        /// <param name="list">The linked list.</param>
        /// <param name="node">
        ///     The node before which to search for the value in the linked list, or <c>null</c> to search from the
        ///     end.
        /// </param>
        /// <param name="value">The value to locate in the linked list.</param>
