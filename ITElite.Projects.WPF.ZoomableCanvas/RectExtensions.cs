namespace System.Windows
{
    ...
    public static class RectExtensions
    {
        ...
        /// <returns>
        ///     <c>true</c> if rect defines an area or point in finite space, which is not the case for
        ///     <see cref="Rect.Empty" /> or if any of the fields are <see cref="double.NaN" />.
        /// </returns>
        ...
        /// <summary>
        ///     Indicates whether the specified rectangle intersects with the current rectangle, properly considering the empty
        ///     rect and infinities.
        /// </summary>
