...
namespace System
{
    ...
    public static class MathExtensions
    {
        ...
        {
            var step = start <= bound ? (decimal)1 : (decimal)-1; for (decimal i = start; i < bound; i += step) yield return i;
        }
        ...
        {
            var step = start <= bound ? (double)1 : (double)-1; for (double i = start; i < bound; i += step) yield return i;
        }
        ...
        {
            var step = start <= bound ? (float)1 : (float)-1; for (float i = start; i < bound; i += step) yield return i;
        }
        ...
        {
            var step = start <= bound ? (long)1 : (long)-1; for (long i = start; i < bound; i += step) yield return i;
        }
        ...
        {
            var step = start <= bound ? (int)1 : (int)-1; for (int i = start; i < bound; i += step) yield return i;
        }
