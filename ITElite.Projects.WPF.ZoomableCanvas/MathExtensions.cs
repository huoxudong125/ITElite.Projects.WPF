...
namespace System
{
    ...
    public static class MathExtensions
    {
        ...
        /// <returns>
        ///     The smallest integer greater than or equal to value. If value is equal to <see cref="F:System.Double.NaN" />,
        ///     <see cref="F:System.Double.NegativeInfinity" />, or <see cref="F:System.Double.PositiveInfinity" />, that value is
        ///     returned.
        /// </returns>
        ...
        /// <returns>
        ///     The largest integer less than or equal to value. If value is equal to <see cref="F:System.Double.NaN" />,
        ///     <see cref="F:System.Double.NegativeInfinity" />, or <see cref="F:System.Double.PositiveInfinity" />, that value is
        ///     returned.
        /// </returns>
        /// <param name="value">A double-precision floating-point number.</param>
        ...
        /// <returns>
        ///     Parameter a or b, whichever is larger. If a, b, or both a and b are equal to
        ...
        /// <returns>
        ///     Parameter a or b, whichever is larger. If a, or b, or both a and b are equal to
        ...
        /// <returns>
        ///     Parameter a or b, whichever is smaller. If a, b, or both a and b are equal to
        ///     <see cref="F:System.Double.NaN" />, <see cref="F:System.Double.NaN" /> is returned.
        /// </returns>
        /// <param name="a">The first of two double-precision floating-point numbers to compare.</param>
        /// <param name="b">The second of two double-precision floating-point numbers to compare.</param>
        ...
        /// <returns>
        ///     A value between a and b inclusively. If a, b, or both a and b are equal to <see cref="F:System.Double.NaN" />,
        ...
        /// <returns>
        ///     A value between a and b inclusively. If a, b, or both a and b are equal to <see cref="F:System.Single.NaN" />,
        ...
        /// <returns>
        ///     The integer nearest parameter value. If value is halfway between two integers, one of which is even and the
        ...
        /// <returns>
        ///     The integer nearest value. If value is halfway between two integers, one of which is even and the other odd,
        ///     then the even number is returned.
        /// </returns>
        ...
        /// <returns>
        ///     The number nearest value with a precision equal to decimals. If value is halfway between two numbers, one of
        ///     which is even and the other odd, then the even number is returned. If the precision of value is less than decimals,
        ...
        /// </summary>
        /// <returns>
        ///     The integer nearest value. If value is halfway between two numbers, one of which is even and the other odd,
        ///     then mode determines which of the two is returned.
        /// </returns>
        /// <param name="value">A decimal number to be rounded.</param>
        ...
        /// <returns>
        ///     The number nearest value with a precision equal to digits. If value is halfway between two numbers, one of
        ///     which is even and the other odd, then the even number is returned. If the precision of value is less than digits,
        ///     then value is returned unchanged.
        /// </returns>
        ...
        /// <summary>
        ///     Rounds a decimal value to a specified precision. A parameter specifies how to round the value if it is midway
        ///     between two other numbers.
        /// </summary>
        /// <returns>
        ///     The number nearest value with a precision equal to decimals. If value is halfway between two numbers, one of
        ///     which is even and the other odd, then mode determines which of the two numbers is returned. If the precision of
        ///     value is less than decimals, then value is returned unchanged.
        /// </returns>
        /// <param name="value">A decimal number to be rounded.</param>
        /// <param name="mode">Specification for how to round value if it is midway between two other numbers.</param>
        /// <param name="decimals">The number of significant decimal places  (precision) in the return value.</param>
        ...
        /// <summary>
        ///     Rounds a double-precision floating-point value to the specified precision. A parameter specifies how to round
        ///     the value if it is midway between two other numbers.
        /// </summary>
        /// <returns>
        ///     The number nearest value with a precision equal to digits. If value is halfway between two numbers, one of
        ///     which is even and the other odd, then the mode parameter determines which number is returned. If the precision of
        ///     value is less than digits, then value is returned unchanged.
        /// </returns>
        /// <param name="mode">Specification for how to round value if it is midway between two other numbers.</param>
        /// <param name="digits">The number of significant digits (precision) in the return value.</param>
        /// <param name="value">A double-precision floating-point number to be rounded.</param>
        ...
        {
            var d = (value%factor);
            return d == 0 ? value : value < 0 ? value - d : value + (factor - d);
        }
        ...
        {
            var d = (value%factor);
            return (short) (d == 0 ? value : value < 0 ? value - d : value + (factor - d));
        }
        ...
        {
            var d = (value%factor);
            return (byte) (d == 0 ? value : value + (factor - d));
        }
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.Decimal.MinValue" /> ≤ value ≤
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.Double.MinValue" /> ≤ value ≤
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.Single.MinValue" /> ≤ value ≤
        ///     <see cref="F:System.Single.MaxValue" />.
        /// </param>
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.Int16.MinValue" /> &lt; value ≤
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.Int32.MinValue" /> &lt; value ≤
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.Int64.MinValue" /> &lt; value ≤
        ...
        /// <param name="value">
        ///     A number in the range <see cref="F:System.SByte.MinValue" /> &lt; value ≤
        ///     <see cref="F:System.SByte.MaxValue" />.
        /// </param>
        ...
        /// <returns>
        ///     The number e raised to the power value. If value equals <see cref="F:System.Double.NaN" /> or
        ///     <see cref="F:System.Double.PositiveInfinity" />, that value is returned. If value equals
        ///     <see cref="F:System.Double.NegativeInfinity" />, 0 is returned.
        /// </returns>
        ...
        /// <returns>
        ///     A number equal to x - (y Q), where Q is the quotient of x / y rounded to the nearest integer (if x / y falls
        ///     halfway between two integers, the even integer is returned).If x - (y Q) is zero, the value +0 is returned if x is
        ///     positive, or -0 if x is negative. If y = 0, <see cref="F:System.Double.NaN" /> (Not-A-Number) is returned.
        /// </returns>
        ...
        /// <returns>
        ///     A number indicating the sign of value.Number Description -1 value is less than zero. 0 value is equal to zero.
        ...
        /// <summary>
        ///     Retrieves the value of the specified number, or zero if it's not a number (<see cref="F:System.Double.NaN" />
        ///     ).
        /// </summary>
        /// <returns>
        ///     The value of the <paramref name="value" /> parameter if it doesn't evaluate to
        ///     <see cref="F:System.Double.NaN" />; otherwise, 0.0.
        /// </returns>
        /// <param name="value">A double-precision floating-point number. </param>
        ...
        /// <summary>
        ///     Retrieves the value of the specified number, or the specified default value if it's not a number (
        ///     <see cref="F:System.Double.NaN" />).
        /// </summary>
        /// <returns>
        ///     The value of the <paramref name="value" /> parameter if it doesn't evaluate to
        ///     <see cref="F:System.Double.NaN" />; otherwise, the <paramref name="defaultValue" /> parameter.
        /// </returns>
        /// <param name="value">A double-precision floating-point number. </param>
        ...
        /// <summary>
        ///     Retrieves the value of the specified number, or zero if it's not a number (<see cref="F:System.Single.NaN" />
        ///     ).
        /// </summary>
        /// <returns>
        ///     The value of the <paramref name="value" /> parameter if it doesn't evaluate to
        ///     <see cref="F:System.Single.NaN" />; otherwise, 0.0.
        /// </returns>
        ...
        /// <returns>
        ///     The value of the <paramref name="value" /> parameter if it doesn't evaluate to
        ///     <see cref="F:System.Single.NaN" />; otherwise, the <paramref name="defaultValue" /> parameter.
        /// </returns>
        /// <param name="value">A single-precision floating-point number. </param>
        /// <param name="defaultValue">The value to return if <see cref="IsNaN" /> returns true.</param>
        ...
        /// <returns>
        ///     An angle, θ, measured in radians, such that 0 ≤ θ ≤ π -or- <see cref="F:System.Double.NaN" /> if value &lt; -1
        ///     or value &gt; 1.
        /// </returns>
        ...
        /// <returns>
        ///     An angle, θ, measured in radians, such that -π/2 ≤ θ ≤ π/2 -or- <see cref="F:System.Double.NaN" /> if value
        ///     &lt; -1 or value &gt; 1.
        /// </returns>
        ...
        /// <returns>
        ///     An angle, θ, measured in radians, such that -π/2 ≤ θ ≤ π/2 -or- <see cref="F:System.Double.NaN" /> if value
        ///     equals <see cref="F:System.Double.NaN" />, -π/2 rounded to double precision (-1.5707963267949) if value equals
        ///     <see cref="F:System.Double.NegativeInfinity" />, or π/2 rounded to double precision (1.5707963267949) if value
        ...
        ///     Cartesian plane. See <see cref="Math.Atan2" /> for details.
        /// </returns>
        ...
        /// <returns>
        ///     The hyperbolic cosine of angle. If angle is equal to <see cref="F:System.Double.NegativeInfinity" /> or
        ///     <see cref="F:System.Double.PositiveInfinity" />, <see cref="F:System.Double.PositiveInfinity" /> is returned. If
        ///     angle is equal to <see cref="F:System.Double.NaN" />, <see cref="F:System.Double.NaN" /> is returned.
        /// </returns>
        /// <param name="angle">An angle, measured in radians.</param>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        ...
        /// <returns>
        ///     The sine of angle. If angle is equal to <see cref="F:System.Double.NaN" />,
        ///     <see cref="F:System.Double.NegativeInfinity" />, or <see cref="F:System.Double.PositiveInfinity" />, this method
        ///     returns <see cref="F:System.Double.NaN" />.
        /// </returns>
        /// <param name="angle">An angle, measured in radians.</param>
        ...
        /// <returns>
        ///     The hyperbolic sine of angle. If angle is equal to <see cref="F:System.Double.NegativeInfinity" />,
        ///     <see cref="F:System.Double.PositiveInfinity" />, or <see cref="F:System.Double.NaN" />, this method returns a
        ///     <see cref="T:System.Double" /> equal to angle.
        /// </returns>
        /// <param name="angle">An angle, measured in radians.</param>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        ...
        /// <returns>
        ///     The tangent of angle. If angle is equal to <see cref="F:System.Double.NaN" />,
        ///     <see cref="F:System.Double.NegativeInfinity" />, or <see cref="F:System.Double.PositiveInfinity" />, this method
        ///     returns <see cref="F:System.Double.NaN" />.
        /// </returns>
        /// <param name="angle">An angle, measured in radians.</param>
        ...
        /// <returns>
        ///     The hyperbolic tangent of angle. If angle is equal to <see cref="F:System.Double.NegativeInfinity" />, this
        ///     method returns -1. If angle is equal to <see cref="F:System.Double.PositiveInfinity" />, this method returns 1. If
        ///     angle is equal to <see cref="F:System.Double.NaN" />, this method returns <see cref="F:System.Double.NaN" />.
        /// </returns>
        /// <param name="angle">An angle, measured in radians.</param>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        ...
        /// <returns>
        ///     A sequence of numbers from start to (but not including) bound where each number is 1 greater than the previous
        ///     number.
        /// </returns>
        ...
        {
            var step = start <= bound ? 1 : (decimal) -1;
            for (var i = start; i < bound; i += step) yield return i;
        }

        /// <summary>Generates a sequence of decimal numbers within a specified range.</summary>
        /// <returns>
        ///     A sequence of numbers from start to (but not including) bound where each number is a given step greater than
        ///     the previous number.
        /// </returns>
        /// <param name="start">The number to start from.</param>
        /// <param name="bound">The number to stop before.</param>
        ...
        {
            var step = start <= bound ? 1 : (double) -1;
            for (var i = start; i < bound; i += step) yield return i;
        }
        ...
        {
            var step = start <= bound ? 1 : (float) -1;
            for (var i = start; i < bound; i += step) yield return i;
        }
        ...
        {
            var step = start <= bound ? (short) 1 : (short) -1;
            for (var i = start; i < bound; i += step) yield return i;
        }
